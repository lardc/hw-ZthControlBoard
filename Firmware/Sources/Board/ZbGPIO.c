...
void ZbGPIO_Init()
{
	...
	ZwGPIO_WritePin(PIN_OUTPUT_LOCK, TRUE);
	...
	ZwGPIO_PinToOutput(PIN_OUTPUT_LOCK);
...
{
	ZwGPIO_WritePin(PIN_OUTPUT_LOCK, State);
}
// ----------------------------------------
...
{
	return ZwGPIO_ReadPin(PIN_T_TR1);
}
// ----------------------------------------

Boolean ZbGPIO_IsTransformer2Overheated()
{
	return ZwGPIO_ReadPin(PIN_T_TR2);
}
// ----------------------------------------
