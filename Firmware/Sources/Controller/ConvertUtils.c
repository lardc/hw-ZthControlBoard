...
void CONVERT_CacheVariables()
{
	...
	{
		ADC_ParamsTcase1 = CONVERT_LoadParams(REG_ADC_T_CASE_S2_P2, REG_ADC_T_CASE_S2_P1, REG_ADC_T_CASE_S2_P0, REG_ADC_T_CASE1_K, REG_ADC_T_CASE1_B, 100);
		ADC_ParamsTcool1 = CONVERT_LoadParams(REG_ADC_T_COOL_S2_P2, REG_ADC_T_COOL_S2_P1, REG_ADC_T_COOL_S2_P0, REG_ADC_T_COOL1_K, REG_ADC_T_COOL1_B, 100);
	}
}
// ----------------------------------------
