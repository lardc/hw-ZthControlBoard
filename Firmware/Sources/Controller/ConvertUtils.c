...
void CONVERT_CacheVariables()
{
	...
	if(DataTable[REG_COOLING_MODE])
	{
		ADC_ParamsTcase1 = CONVERT_LoadParams(REG_ADC_T_CASE1_S1_P2, REG_ADC_T_CASE1_S1_P1, REG_ADC_T_CASE1_S1_P0, REG_ADC_T_CASE1_K, REG_ADC_T_CASE1_B, 100);
		ADC_ParamsTcool1 = CONVERT_LoadParams(REG_ADC_T_COOL1_S1_P2, REG_ADC_T_COOL1_S1_P1, REG_ADC_T_COOL1_S1_P0, REG_ADC_T_COOL1_K, REG_ADC_T_COOL1_B, 100);
		ADC_ParamsTcase2 = CONVERT_LoadParams(REG_ADC_T_CASE2_S1_P2, REG_ADC_T_CASE2_S1_P1, REG_ADC_T_CASE2_S1_P0, REG_ADC_T_CASE2_K, REG_ADC_T_CASE2_B, 100);
		ADC_ParamsTcool2 = CONVERT_LoadParams(REG_ADC_T_COOL2_S1_P2, REG_ADC_T_COOL2_S1_P1, REG_ADC_T_COOL2_S1_P0, REG_ADC_T_COOL2_K, REG_ADC_T_COOL2_B, 100);
	}
	else
	{
		ADC_ParamsTcase1 = ADC_ParamsTcase2 = CONVERT_LoadParams(REG_ADC_T_CASE_S2_P2, REG_ADC_T_CASE_S2_P1, REG_ADC_T_CASE_S2_P0, REG_ADC_T_CASE1_K, REG_ADC_T_CASE1_B, 100);
		ADC_ParamsTcool1 = ADC_ParamsTcool2 = CONVERT_LoadParams(REG_ADC_T_COOL_S2_P2, REG_ADC_T_COOL_S2_P1, REG_ADC_T_COOL_S2_P0, REG_ADC_T_COOL1_K, REG_ADC_T_COOL1_B, 100);
	}
}
// ----------------------------------------
