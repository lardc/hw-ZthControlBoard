...
PAGE 0:    /* Program Memory */
   ...
   LOADED_BEGIN : origin = 0x3E8000, length = 0x000002     /* Part of FLASHD. Entry point for main firmware */
   FLASHD       : origin = 0x3E8002, length = 0x003FFE     /* on-chip FLASH */
...
Flash28_API:
   ...
   .cinit              : > FLASHA      		PAGE = 0  /* пам€ть дл€ глобальных переменных */
   .pinit              : > FLASHA,    		PAGE = 0  /* значени€ начальной инициализации переменных */
   .text               : > FLASHA      		PAGE = 0  /* содержит исполн€емый код и константы */
   codestart           : > BEGIN            PAGE = 0  /* в codestart сщдержитс€ адрес старта программы BEGIN */
   ...
   .stack              : > RAML1       PAGE = 1  /* системный стек (дл€ сохранени€ контекста процессора при вызове процедур) */
   .esysmem            : > RAMH0       PAGE = 1
   .ebss               : > RAML1       PAGE = 1
   /* Initalized sections go in Flash */
   /* For SDFlash to program these, they must be allocated to page 0 */
   .econst             : > FLASHA      PAGE = 0  /*инициализаци€ констант (дл€ €зыка —)*/
